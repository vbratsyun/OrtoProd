document.addEventListener("DOMContentLoaded", () => {
  ...
  const usefulArticles = document.querySelector(".useful-articles");

  if (usefulArticles) {
    usefulArticles.classList.remove("useful-articles--nojs");
  }
  ...
  if (buttonBack && buttonForward && list) {
    ...
    if (!pager) {
      ...
      pager.innerHTML =
        '<span class="carousel__current"></span>&nbsp;из&nbsp;<span class="carousel__total"></span>';
